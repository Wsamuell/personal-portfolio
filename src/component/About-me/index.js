            ...
            <div className='flex flex-wrap w-screen justify-center items-center'>
                ...
                <article className="flex flex-wrap space-x-4 tools">
                    <div className="text-center  about-paragraph flex-1 bg-white shadow-2xl rounded-lg my-20">
                        ...
                        <div className="">
                            ...
                            <br />
                            <p className=""> I value the UX perspective of design because as well all know, that what brings in the customers</p>
                            <br />
                    ...
                    <div className="text-center about-paragraph flex-1 bg-white shadow-2xl rounded-lg my-20">
                        ...
                        <br />
                        <p className="">I don't just thieve on the Front-end, i can take it out Back(end)
                        </p>
                        <br />
                        <p className="tool-title-sm"> My Tools</p>
                        <br />
                ...
                <div className='about-paragraph max-w-3xl bg-white shadow-xl rounded-lg my-20'>
                    ...
                    <div className='about-text text-justify'>
                        ...
                        <br />
                        <p>I am a very simple person with big dreams, I have had my share of mistakes but I'll never let that stop me. No matter how big or small my challenge is, i will see it to the end</p>
                        <br />
