            ...
            <div className='contact-form flex-wrap max-w-3xl'>
                ...
                <div className='flex flex-col contact-form shadow-2xl rounded-lg  text-center'>
                    <div className='flex flex-row justify-evenly contact-icons'>
                        ...
                        <a href="https://www.linkedin.com/in/samuel-odubamowo-567229207/" target="_blank"><img className='w-20 h-20 text-center ux-img object-center' src={require("../../asset/img/linkedin.png").default} alt='linkin-icon' /></a>
